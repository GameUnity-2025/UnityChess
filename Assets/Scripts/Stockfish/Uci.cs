...
namespace ChessEngine.Stockfish
{
        ...
        public static void loop(String[] argv)
        {
            ...
            do
            {
                ...
                else if (token == "perft" || token == "divide")
                {
                    ...
                    // Engine.benchmark(pos, ss);  // Commented out as method not implemented
                }
                else if (token == "key")
                {
                ...
                else if (token == "bench") { /* Engine.benchmark(pos, stack); */ }  // Commented out
                else if (token == "benchfile") { /* Engine.benchfile(pos, stack); */ }  // Commented out
