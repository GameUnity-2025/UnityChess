...
namespace ChessEngine.Stockfish
{
    public sealed class Material
    {
        ...
        public static Phase game_phase(Position pos)
        {
            ...
            return npm >= ValueS.MidgameLimit ? PhaseS.PHASE_MIDGAME
                    : npm <= ValueS.EndgameLimit ? PhaseS.PHASE_ENDGAME
                    : (Phase)(((npm - ValueS.EndgameLimit) * 128) / (ValueS.MidgameLimit - ValueS.EndgameLimit));
        }
