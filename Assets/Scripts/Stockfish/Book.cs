...
namespace ChessEngine.Stockfish
{
    public sealed class PolyglotBook
    {
        ...
        //public static readonly Key[] PG = new Key[781]{
        public static Key[] PG = new Key[781]{
        ...
        public const int psq = 0;
        public const int castle = 768;// Pieces * squares
        public const int enpassant = 772;// Castle flags
        public const int turn = 780;// Number of files

        //public readonly RKISS RKiss;
        public RKISS RKiss;
        ...
        public bool open(string fName)
        {
            ...
            try
            {
                stream = new FileStream(fName, FileMode.Open, FileAccess.Read);
                fileName = fName;
            }
            catch (Exception)
            {
